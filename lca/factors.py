...
FACTORS: dict[str, TechFactors] = {
    "FV": TechFactors(
        tech="Fotovoltaica",
        ghg_median=24,  ghg_p25=13,  ghg_p75=46,
        water_median=0.02,
        land_median=2.5,
        lifetime_yrs=30,
    ),
    "Eólica": TechFactors(
        tech="Eólica",
        ghg_median=11,  ghg_p25=7,   ghg_p75=15,
        water_median=0.004,
    ...
    "CSP": TechFactors(
        ...
        ghg_median=22,  ghg_p25=14,  ghg_p75=32,
    ...
    "Eólica+FV": TechFactors(
        ...
        ghg_median=17,  ghg_p25=10,  ghg_p75=30,  # promedio ponderado
        water_median=0.01,
        land_median=37,
        lifetime_yrs=27,
    ),
    "FV+CSP": TechFactors(
        ...
        ghg_median=23,  ghg_p25=13,  ghg_p75=39,
        water_median=1.5,
        land_median=3.0,
        lifetime_yrs=30,
    ),
